...
const EU_PRODUCTS = [
  ...
  { gtin: 'VDW-MTWO-KIT', name: 'Mtwo Starter Kit', name_fr: 'Kit de démarrage Mtwo', brand: 'Mtwo', manufacturer: 'VDW GmbH', category: 'Endodontie', subcategory: 'Limes endodontiques', sterile: true, single_use: true },
  ...
  { gtin: 'GC-EQFORTE-A2', name: 'EQUIA Forte HT Fil A2', name_fr: 'EQUIA Forte HT capsules A2', brand: 'EQUIA Forte', manufacturer: 'GC Europe', category: 'Composites', subcategory: 'Verre ionomère', sterile: false, single_use: true },
  { gtin: 'GC-EQFORTE-A3', name: 'EQUIA Forte HT Fil A3', name_fr: 'EQUIA Forte HT capsules A3', brand: 'EQUIA Forte', manufacturer: 'GC Europe', category: 'Composites', subcategory: 'Verre ionomère', sterile: false, single_use: true },
  { gtin: 'GC-EQCOAT', name: 'EQUIA Forte Coat', name_fr: 'EQUIA Forte Coat (vernis)', brand: 'EQUIA Forte', manufacturer: 'GC Europe', category: 'Composites', subcategory: 'Verre ionomère', sterile: false, single_use: false },
  { gtin: 'GC-GRADIA-A2', name: 'Gradia Direct Posterior A2', name_fr: 'Gradia Direct Postérieur A2', brand: 'Gradia', manufacturer: 'GC Europe', category: 'Composites', subcategory: 'Composite postérieur', sterile: false, single_use: false },
  ...
  // ═══ PROTHESE / LABO EU ═══
  { gtin: 'ZZ-PRETTAU-98H14', name: 'Prettau Anterior 98mm H14', name_fr: 'Disque Prettau Anterior 98mm H14', brand: 'Prettau', manufacturer: 'Zirkonzahn', category: 'Prothèse', subcategory: 'Zircone', sterile: false, single_use: false },
  { gtin: 'ZZ-PRETTAU-98H20', name: 'Prettau Anterior 98mm H20', name_fr: 'Disque Prettau Anterior 98mm H20', brand: 'Prettau', manufacturer: 'Zirkonzahn', category: 'Prothèse', subcategory: 'Zircone', sterile: false, single_use: false },
  { gtin: 'AG-ZOLID-FX-ML', name: 'Zolid FX Multilayer 98mm', name_fr: 'Disque Zolid FX Multilayer 98mm', brand: 'Zolid', manufacturer: 'Amann Girrbach', category: 'Prothèse', subcategory: 'Zircone', sterile: false, single_use: false },
  { gtin: 'VITA-YZ-ST-A2', name: 'VITA YZ ST Color A2', name_fr: 'Disque VITA YZ ST Color A2', brand: 'VITA YZ', manufacturer: 'VITA Zahnfabrik', category: 'Prothèse', subcategory: 'Zircone', sterile: false, single_use: false },
  { gtin: 'IVOCLAR-EMAX-HT-A2', name: 'IPS e.max CAD HT A2 C14', name_fr: 'Bloc IPS e.max CAD HT A2 C14', brand: 'e.max', manufacturer: 'Ivoclar Vivadent', category: 'Prothèse', subcategory: 'Céramique', sterile: false, single_use: false },
  { gtin: 'IVOCLAR-EMAX-LT-A2', name: 'IPS e.max CAD LT A2 C14', name_fr: 'Bloc IPS e.max CAD LT A2 C14', brand: 'e.max', manufacturer: 'Ivoclar Vivadent', category: 'Prothèse', subcategory: 'Céramique', sterile: false, single_use: false },
  ...
  { gtin: 'EMS-AIRFLOW-PROP', name: 'AIRFLOW Prophylaxis Master', name_fr: 'AIRFLOW Prophylaxis Master', brand: 'AIRFLOW', manufacturer: 'EMS', category: 'Instruments', subcategory: 'Détartreurs', sterile: false, single_use: false },
  ...
  // ═══ ANESTHESIE EU ═══
  { gtin: 'SEPT-ARTI-172', name: 'Septanest 1/200.000 articaine 4%', name_fr: 'Septanest articaine 4% adrenaline 1/200.000', brand: 'Septanest', manufacturer: 'Septodont', category: 'Anesthésie', subcategory: 'Carpules', sterile: true, single_use: true },
  { gtin: 'SEPT-ARTI-100', name: 'Septanest SP 1/100.000 articaine 4%', name_fr: 'Septanest SP articaine 4% adrenaline 1/100.000', brand: 'Septanest', manufacturer: 'Septodont', category: 'Anesthésie', subcategory: 'Carpules', sterile: true, single_use: true },
  { gtin: 'SEPT-SCANDONEST', name: 'Scandonest 3% mepivacaine', name_fr: 'Scandonest mépivacaïne 3% sans vasoconstricteur', brand: 'Scandonest', manufacturer: 'Septodont', category: 'Anesthésie', subcategory: 'Carpules', sterile: true, single_use: true },

  // ═══ RADIOLOGIE EU ═══
  { gtin: 'OWANDY-OPTEO', name: 'Opteo Intraoral Sensor', name_fr: 'Capteur intraoral Opteo', brand: 'Opteo', manufacturer: 'Owandy Radiology', category: 'Radiologie', subcategory: 'Capteurs numériques', sterile: false, single_use: false },
  { gtin: 'VATECH-EZRAY', name: 'EzRay Air Portable', name_fr: 'Générateur portable EzRay Air', brand: 'EzRay', manufacturer: 'Vatech', category: 'Radiologie', subcategory: 'Capteurs numériques', sterile: false, single_use: false },
  ...
  // ═══ STERILISATION EU ═══
  { gtin: 'MELAG-PREMIUM44', name: 'MELAtherm 44 Washer Disinfector', name_fr: 'Thermodésinfecteur MELAtherm 44', brand: 'MELAtherm', manufacturer: 'MELAG', category: 'Stérilisation', subcategory: 'Nettoyage instruments', sterile: false, single_use: false },
  { gtin: 'MELAG-VACUKLAV44', name: 'Vacuklav 44B+ Autoclave', name_fr: 'Autoclave Vacuklav 44B+', brand: 'Vacuklav', manufacturer: 'MELAG', category: 'Stérilisation', subcategory: 'Autoclaves', sterile: false, single_use: false },
...
async function main() {
  ...
  log(`║  ${EU_PRODUCTS.length} produits à insérer              ║`);
  log('╚══════════════════════════════════════════════╝');
  ...
  log(`\n${'='.repeat(50)}`);
  log(`SEED EU TERMINÉ : ${inserted}/${EU_PRODUCTS.length} insérés`);
  log('Par catégorie :');
