...
DROP POLICY IF EXISTS "labo_techniciens_select" ON labo_techniciens;
...
DROP POLICY IF EXISTS "labo_techniciens_insert" ON labo_techniciens;
...
DROP POLICY IF EXISTS "labo_techniciens_update" ON labo_techniciens;
...
DROP POLICY IF EXISTS "labo_production_cases_select" ON labo_production_cases;
CREATE POLICY "labo_production_cases_select" ON labo_production_cases
  FOR SELECT TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_production_cases_insert" ON labo_production_cases;
CREATE POLICY "labo_production_cases_insert" ON labo_production_cases
  FOR INSERT TO authenticated
  WITH CHECK (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_production_cases_update" ON labo_production_cases;
CREATE POLICY "labo_production_cases_update" ON labo_production_cases
  FOR UPDATE TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_production_etapes_select" ON labo_production_etapes;
...
DROP POLICY IF EXISTS "labo_production_etapes_insert" ON labo_production_etapes;
...
DROP POLICY IF EXISTS "labo_production_etapes_update" ON labo_production_etapes;
...
DROP POLICY IF EXISTS "labo_remakes_select" ON labo_remakes;
CREATE POLICY "labo_remakes_select" ON labo_remakes
  FOR SELECT TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_remakes_insert" ON labo_remakes;
CREATE POLICY "labo_remakes_insert" ON labo_remakes
  FOR INSERT TO authenticated
  WITH CHECK (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_remakes_update" ON labo_remakes;
...
DROP POLICY IF EXISTS "labo_garanties_select" ON labo_garanties;
CREATE POLICY "labo_garanties_select" ON labo_garanties
  FOR SELECT TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_garanties_insert" ON labo_garanties;
CREATE POLICY "labo_garanties_insert" ON labo_garanties
  FOR INSERT TO authenticated
  WITH CHECK (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_garanties_update" ON labo_garanties;
CREATE POLICY "labo_garanties_update" ON labo_garanties
  FOR UPDATE TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_garantie_reclamations_select" ON labo_garantie_reclamations;
...
DROP POLICY IF EXISTS "labo_garantie_reclamations_insert" ON labo_garantie_reclamations;
...
DROP POLICY IF EXISTS "labo_garantie_reclamations_update" ON labo_garantie_reclamations;
CREATE POLICY "labo_garantie_reclamations_update" ON labo_garantie_reclamations
  FOR UPDATE TO authenticated
  USING (garantie_id IN (SELECT id FROM labo_garanties WHERE prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid())));

DROP POLICY IF EXISTS "labo_garanties_config_select" ON labo_garanties_config;
CREATE POLICY "labo_garanties_config_select" ON labo_garanties_config
  FOR SELECT TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_garanties_config_insert" ON labo_garanties_config;
CREATE POLICY "labo_garanties_config_insert" ON labo_garanties_config
  FOR INSERT TO authenticated
  WITH CHECK (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_garanties_config_update" ON labo_garanties_config;
...
DROP POLICY IF EXISTS "labo_conversations_select" ON labo_conversations;
CREATE POLICY "labo_conversations_select" ON labo_conversations
  FOR SELECT TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_conversations_insert" ON labo_conversations;
CREATE POLICY "labo_conversations_insert" ON labo_conversations
  FOR INSERT TO authenticated
  WITH CHECK (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_conversations_update" ON labo_conversations;
CREATE POLICY "labo_conversations_update" ON labo_conversations
  FOR UPDATE TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_messages_select" ON labo_messages;
...
DROP POLICY IF EXISTS "labo_messages_insert" ON labo_messages;
...
DROP POLICY IF EXISTS "labo_messages_update" ON labo_messages;
...
DROP POLICY IF EXISTS "labo_shade_cases_select" ON labo_shade_cases;
CREATE POLICY "labo_shade_cases_select" ON labo_shade_cases
  FOR SELECT TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_shade_cases_insert" ON labo_shade_cases;
CREATE POLICY "labo_shade_cases_insert" ON labo_shade_cases
  FOR INSERT TO authenticated
  WITH CHECK (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_shade_cases_update" ON labo_shade_cases;
CREATE POLICY "labo_shade_cases_update" ON labo_shade_cases
  FOR UPDATE TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_shade_photos_select" ON labo_shade_photos;
...
DROP POLICY IF EXISTS "labo_shade_photos_insert" ON labo_shade_photos;
...
DROP POLICY IF EXISTS "labo_expeditions_select" ON labo_expeditions;
CREATE POLICY "labo_expeditions_select" ON labo_expeditions
  FOR SELECT TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_expeditions_insert" ON labo_expeditions;
CREATE POLICY "labo_expeditions_insert" ON labo_expeditions
  FOR INSERT TO authenticated
  WITH CHECK (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_expeditions_update" ON labo_expeditions;
CREATE POLICY "labo_expeditions_update" ON labo_expeditions
  FOR UPDATE TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_expedition_events_select" ON labo_expedition_events;
...
DROP POLICY IF EXISTS "labo_expedition_events_insert" ON labo_expedition_events;
...
DROP POLICY IF EXISTS "labo_planning_conges_select" ON labo_planning_conges;
CREATE POLICY "labo_planning_conges_select" ON labo_planning_conges
  FOR SELECT TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_planning_conges_insert" ON labo_planning_conges;
CREATE POLICY "labo_planning_conges_insert" ON labo_planning_conges
  FOR INSERT TO authenticated
  WITH CHECK (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_planning_conges_update" ON labo_planning_conges;
...
DROP POLICY IF EXISTS "labo_machines_select" ON labo_machines;
CREATE POLICY "labo_machines_select" ON labo_machines
  FOR SELECT TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_machines_insert" ON labo_machines;
CREATE POLICY "labo_machines_insert" ON labo_machines
  FOR INSERT TO authenticated
  WITH CHECK (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_machines_update" ON labo_machines;
CREATE POLICY "labo_machines_update" ON labo_machines
  FOR UPDATE TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_interventions_select" ON labo_interventions;
...
DROP POLICY IF EXISTS "labo_interventions_insert" ON labo_interventions;
...
DROP POLICY IF EXISTS "labo_fichiers3d_select" ON labo_fichiers3d;
CREATE POLICY "labo_fichiers3d_select" ON labo_fichiers3d
  FOR SELECT TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_fichiers3d_insert" ON labo_fichiers3d;
CREATE POLICY "labo_fichiers3d_insert" ON labo_fichiers3d
  FOR INSERT TO authenticated
  WITH CHECK (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_fichiers3d_update" ON labo_fichiers3d;
CREATE POLICY "labo_fichiers3d_update" ON labo_fichiers3d
  FOR UPDATE TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_validations_3d_select" ON labo_validations_3d;
CREATE POLICY "labo_validations_3d_select" ON labo_validations_3d
  FOR SELECT TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_validations_3d_insert" ON labo_validations_3d;
CREATE POLICY "labo_validations_3d_insert" ON labo_validations_3d
  FOR INSERT TO authenticated
  WITH CHECK (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_validations_3d_update" ON labo_validations_3d;
...
DROP POLICY IF EXISTS "labo_patient_liens_select" ON labo_patient_liens;
CREATE POLICY "labo_patient_liens_select" ON labo_patient_liens
  FOR SELECT TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_patient_liens_insert" ON labo_patient_liens;
CREATE POLICY "labo_patient_liens_insert" ON labo_patient_liens
  FOR INSERT TO authenticated
  WITH CHECK (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_patient_liens_update" ON labo_patient_liens;
...
DROP POLICY IF EXISTS "labo_reseau_profils_select" ON labo_reseau_profils;
CREATE POLICY "labo_reseau_profils_select" ON labo_reseau_profils
  FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "labo_reseau_profils_insert" ON labo_reseau_profils;
CREATE POLICY "labo_reseau_profils_insert" ON labo_reseau_profils
  FOR INSERT TO authenticated
  WITH CHECK (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));
DROP POLICY IF EXISTS "labo_reseau_profils_update" ON labo_reseau_profils;
CREATE POLICY "labo_reseau_profils_update" ON labo_reseau_profils
  FOR UPDATE TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_reseau_annonces_select" ON labo_reseau_annonces;
CREATE POLICY "labo_reseau_annonces_select" ON labo_reseau_annonces
  FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "labo_reseau_annonces_insert" ON labo_reseau_annonces;
CREATE POLICY "labo_reseau_annonces_insert" ON labo_reseau_annonces
  FOR INSERT TO authenticated
  WITH CHECK (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));
DROP POLICY IF EXISTS "labo_reseau_annonces_update" ON labo_reseau_annonces;
CREATE POLICY "labo_reseau_annonces_update" ON labo_reseau_annonces
  FOR UPDATE TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_reseau_reponses_select" ON labo_reseau_reponses;
CREATE POLICY "labo_reseau_reponses_select" ON labo_reseau_reponses
  FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "labo_reseau_reponses_insert" ON labo_reseau_reponses;
CREATE POLICY "labo_reseau_reponses_insert" ON labo_reseau_reponses
  FOR INSERT TO authenticated
  WITH CHECK (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_achats_groupes_select" ON labo_achats_groupes;
CREATE POLICY "labo_achats_groupes_select" ON labo_achats_groupes
  FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "labo_achats_groupes_insert" ON labo_achats_groupes;
...
DROP POLICY IF EXISTS "labo_achats_groupes_update" ON labo_achats_groupes;
...
DROP POLICY IF EXISTS "labo_achats_groupes_participants_select" ON labo_achats_groupes_participants;
CREATE POLICY "labo_achats_groupes_participants_select" ON labo_achats_groupes_participants
  FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "labo_achats_groupes_participants_insert" ON labo_achats_groupes_participants;
CREATE POLICY "labo_achats_groupes_participants_insert" ON labo_achats_groupes_participants
  FOR INSERT TO authenticated
  WITH CHECK (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_reseau_entraide_select" ON labo_reseau_entraide;
CREATE POLICY "labo_reseau_entraide_select" ON labo_reseau_entraide
  FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "labo_reseau_entraide_insert" ON labo_reseau_entraide;
CREATE POLICY "labo_reseau_entraide_insert" ON labo_reseau_entraide
  FOR INSERT TO authenticated
  WITH CHECK (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));
DROP POLICY IF EXISTS "labo_reseau_entraide_update" ON labo_reseau_entraide;
CREATE POLICY "labo_reseau_entraide_update" ON labo_reseau_entraide
  FOR UPDATE TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_reseau_entraide_reponses_select" ON labo_reseau_entraide_reponses;
CREATE POLICY "labo_reseau_entraide_reponses_select" ON labo_reseau_entraide_reponses
  FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "labo_reseau_entraide_reponses_insert" ON labo_reseau_entraide_reponses;
...
DROP POLICY IF EXISTS "labo_abonnements_select" ON labo_abonnements;
CREATE POLICY "labo_abonnements_select" ON labo_abonnements
  FOR SELECT TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));
DROP POLICY IF EXISTS "labo_abonnements_insert" ON labo_abonnements;
CREATE POLICY "labo_abonnements_insert" ON labo_abonnements
  FOR INSERT TO authenticated
  WITH CHECK (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));
DROP POLICY IF EXISTS "labo_abonnements_update" ON labo_abonnements;
CREATE POLICY "labo_abonnements_update" ON labo_abonnements
  FOR UPDATE TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));

DROP POLICY IF EXISTS "labo_abonnements_historique_select" ON labo_abonnements_historique;
CREATE POLICY "labo_abonnements_historique_select" ON labo_abonnements_historique
  FOR SELECT TO authenticated
  USING (prothesiste_id IN (SELECT id FROM labo_prothesistes WHERE user_id = auth.uid()));
DROP POLICY IF EXISTS "labo_abonnements_historique_insert" ON labo_abonnements_historique;
...
DROP POLICY IF EXISTS equiv_read_all ON product_equivalences;
CREATE POLICY equiv_read_all ON product_equivalences
  FOR SELECT USING (true);
DROP POLICY IF EXISTS equiv_insert_auth ON product_equivalences;
CREATE POLICY equiv_insert_auth ON product_equivalences
  FOR INSERT WITH CHECK (auth.role() = 'authenticated');
DROP POLICY IF EXISTS equiv_update_auth ON product_equivalences;
...
DO $$ BEGIN
DROP POLICY IF EXISTS pages_all ON public.vitrines_pages;
...
DO $$ BEGIN
DROP POLICY IF EXISTS staging_all ON public.staging_sites;
